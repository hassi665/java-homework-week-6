Feature: Bookcategory
  ...
  Scenario Outline: I should be able to see top menu tabs on homepage with categories
    When I an on nome page
    Then I should be able to gee top menu tabs with "<categories>"
    Examples:
      | categories        |
      | I compuer         |
      | Electronic        |
  ...
  Scenario Outline: I should be able to see list of terms of each filters
    ...
    Then  I should be able to see list "<list>" in dropdown menu
    Examples:
      | filter  | list                                                                            |
  ...
  Scenario Outline: I should be able to see prodcut display format according display format type as per given picture in srs document
    ...
    Then  I  should be able to see product display format according display format type as per given picture in SR document
    Examples:
      | display format icon |
      | Grid                |
      | List                |
